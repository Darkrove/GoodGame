<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Viewproduct.aspx.cs" Inherits="GoodGame.Viewproduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Good Game | View Product</title>
    <!-- Icon -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <asp:Repeater ID="RepeaterProductTable" runat="server">
            <HeaderTemplate>
                <table class="table table-striped table-dark">
                    <thead>
                        <tr>
                            <th style="vertical-align: middle;" scope="col">Pro Id</th>
                            <th style="vertical-align: middle;" scope="col">Pro Name</th>
                            <th style="vertical-align: middle;" scope="col">Pro Description</th>
                            <th style="vertical-align: middle;" scope="col">Pro Image</th>
                            <th style="vertical-align: middle;" scope="col">Pro Category</th>
                            <th style="vertical-align: middle;" scope="col">Pro Price</th>
            ...
            <ItemTemplate>
                <tr>
                    <th scope="row" style="vertical-align: middle;"><%# Eval("ProId") %></th>
                    <td style="vertical-align: middle;"><%# Eval("ProName") %></td>
                    <td style="vertical-align: middle;"><%# Eval("ProDescription") %></td>
                    <td style="vertical-align: middle;"><a href="<%# Eval("ProPath") %>" target="_blank">Image</a></td>
                    <td style="vertical-align: middle;"><%# Eval("ProCategory") %></td>
                    <td style="vertical-align: middle;"><%# Eval("ProPrice") %></td>
                    <td style="vertical-align: middle;"><a href="Updateproduct.aspx?Id=<%# Eval("ProId") %>">Edit</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
                </tbody>
